    ...
    public String enviarEmailHtml(@PathVariable String destinatario) {
        ...
        try {
            ...
            String html = ""
            		          ...
            		          +"<!-- Botão de Ação -->"
            		          +"<div style='text-align: center; margin-bottom: 24px;'>"
            		          +"<a href='URL_DE_RECUPERACAO_AQUI' target='_blank' style='display: inline-block; background-color: #0066cc; color: #ffffff; font-size: 15px; font-weight: 600; text-decoration: none; padding: 14px 32px; border-radius: 8px; box-shadow: 0 2px 6px rgba(0, 102, 204, 0.2); transition: background-color 0.2s;'>"
            		          ...
            		          +"<a href='URL_DE_RECUPERACAO_AQUI' target='_blank' style='color: #0066cc; text-decoration: none; word-break: break-all;'>CLIQUE AQUI</a>"
            		          +"</p>"    
            		          +"</div>"
            		          +"</div>"
