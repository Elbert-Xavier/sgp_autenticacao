    ...
    public String enviarEmailHtml(@PathVariable String destinatario) {
        ...
        try {
            ...
            String html = ""
            	    ...
            	    + "<div style='text-align: center; margin-bottom: 24px;'>\n"
            	    + "\n"
            	    + "<a href='http://localhost:8000/redefinirSenha.html?email=" + destinatario + "' target='_blank' style='display: inline-block; background-color: #0066cc; color: #ffffff; font-size: 15px; font-weight: 600; text-decoration: none; padding: 14px 32px; border-radius: 8px; box-shadow: 0 2px 6px rgba(0, 102, 204, 0.2);'>\n"
            	    ...
            	    + "<a href='http://localhost:8000/redefinirSenha.htmlemail=" + destinatario + "' target='_blank' style='color: #0066cc; text-decoration: none; word-break: break-all;'>CLIQUE AQUI</a>\n"
            	    + "</p>\n"    
            	    + "</div>\n"
            	    + "</div>\n"
